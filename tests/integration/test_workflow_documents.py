...
"""
    ...
    def test_store_multiple_document_types(self, hmc):
        ...
        # Store spec
        hmc.add_semantic(
            "Specification for user authentication",
            metadata={"type": "spec", "feature": "auth"}
        )
        ...
        hmc.add_semantic(
            ...
            metadata={"type": "task", "feature": "auth"}
        )
        
        # Query by type
        spec_results = hmc.query_semantic(
            "authentication",
            k=10,
            filter={"type": "spec"}
        )
    ...
    def test_complex_workflow_scenario(self, hmc):
        ...
        profile_docs = hmc.query_semantic(
            "profile",
            k=20,
            filter={"feature": "profile"}
        )
    ...
    def test_combined_filters(self, hmc):
        ...
        hmc.add_semantic(
            ...
            metadata={"type": "spec", "feature": "payments", "priority": "P1", "status": "approved"}
        )
        ...
        results = hmc.query_semantic(
            "specification",
            k=10,
            filter={"priority": "P1", "feature": "auth"}
        )
    ...
    def test_factual_and_semantic_integration(self, hmc):
        ...
        security_docs = hmc.query_semantic(
            "security",
            k=5,
            filter={"feature": "security"}
        )
