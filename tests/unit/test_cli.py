...
class TestCLI:
    ...
    def test_seed_with_memory_dir_option(self, runner, temp_project):
        ...
        result = runner.invoke(app, ["seed", str(temp_project), "--memory-dir", ".custom_memory"])
    ...
    def test_seed_with_project_id_option(self, runner, temp_project):
        ...
        result = runner.invoke(
            app, ["seed", str(temp_project), "--project-id", "custom-project-id"]
        )
    ...
    def test_seed_with_verbose_flag(self, runner, temp_project):
        ...
        result = runner.invoke(app, ["seed", str(temp_project), "--verbose"])
    ...
    def test_cli_main_entry_point(self):
        ...
        assert hasattr(cli_app, "command") or callable(cli_app)
